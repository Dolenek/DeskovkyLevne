...
export const SellerOfferTable = ({
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-line bg-white shadow-sm">
      <div className="grid grid-cols-[1.4fr_0.8fr_0.9fr_1fr] gap-3 border-b border-line bg-slate-50 px-4 py-3 text-xs font-extrabold uppercase text-navy">
        <span>E-shop</span>
        <span>Cena</span>
      ...
      <div className="divide-y divide-line">
        {sellers.slice(0, compact ? 4 : 8).map((seller, index) => (
          <div
            ...
            className={`grid grid-cols-[1.4fr_0.8fr_0.9fr_1fr] items-center gap-3 px-4 py-3 text-sm ${
          ...
          >
            ...
            <span className="text-muted">{seller.availabilityLabel ?? "Dle e-shopu"}</span>
            <span className="text-right">
              {seller.url ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-md bg-primary px-3 py-2 text-xs font-extrabold text-white hover:bg-emerald-700"
                >
                  Do obchodu
