...
export const ProductHero = ({ series, locale }: ProductHeroProps) => {
  ...
  return (
    <section className="flex h-full flex-col">
      ...
      <h1 className="mt-5 text-4xl font-black leading-tight text-navy">{series.label}</h1>
      ...
      <div className="mt-6 flex flex-col gap-3 sm:flex-row">
        {series.url ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex flex-1 items-center justify-center gap-2 rounded-lg bg-primary px-5 py-3 font-extrabold text-white hover:bg-emerald-700"
          >
        ...
        <button
          type="button"
          className="inline-flex flex-1 items-center justify-center gap-2 rounded-lg border border-primary px-5 py-3 font-extrabold text-primary"
        >
        ...
        <button
          type="button"
          className="flex h-12 w-14 items-center justify-center rounded-lg border border-line text-navy"
